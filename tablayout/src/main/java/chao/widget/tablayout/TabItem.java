...
import static android.support.design.R.styleable.TabItem_android_icon;
import static android.support.design.R.styleable.TabItem_android_layout;
import static android.support.design.R.styleable.TabItem_android_text;
...
public final class TabItem extends View {
    ...
    public TabItem(Context context, AttributeSet attrs) {
        ...
        final TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs,
                R.styleable.TabItem);
        mText = a.getText(TabItem_android_text);
        mIcon = a.getDrawable(TabItem_android_icon);
        mCustomLayout = a.getResourceId(TabItem_android_layout, 0);
        a.recycle();
    }
}